...
export const metadata = {
  title: 'Our IT & Digital Services | Ideabin.tech',
  description: 'Explore our comprehensive range of services including custom software development, AI solutions, web development, and technical SEO in India.',
};
