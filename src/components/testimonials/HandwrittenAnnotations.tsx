        ...
        <div className="relative">
          <p
            className={`font-editorial text-[22px] md:text-[24px] leading-tight tracking-wide transition-colors duration-300 ${
              isArjunActive
                ...
                : isDark ? 'text-neutral-400 hover:text-purple-300' : 'text-neutral-500 hover:text-purple-700'
            }`}
          >
            Big ideas<br />
            Happier people
          ...
          <div className="w-24 h-16 -mt-1 ml-4 relative">
            <svg
              ...
              fill="none"
              stroke={isArjunActive ? '#c084fc' : isDark ? '#71717a' : '#9ca3af'}
              strokeWidth="2"
              strokeLinecap="round"
          ...
          <div className="absolute -top-1 -right-7 w-8 h-8">
            <svg
              viewBox="0 0 32 32"
              fill="none"
              stroke={isArjunActive ? '#e9d5ff' : isDark ? '#71717a' : '#9ca3af'}
              strokeWidth="1.8"
              strokeLinecap="round"
        ...
        <div className="relative">
          <div
            className={`font-editorial text-[23px] md:text-[25px] leading-[1.25] tracking-wide transition-colors duration-300 ${
              isMayaActive
                ...
                : isDark ? 'text-neutral-400 hover:text-pink-300' : 'text-neutral-500 hover:text-pink-700'
            }`}
          >
            <p>Creative</p>
            <p>Friendly</p>
          ...
          <div className="w-28 h-16 ml-10 -mt-2">
            <svg
              ...
              className="w-full h-full overflow-visible"
              fill="none"
              stroke={isMayaActive ? '#f472b6' : isDark ? '#71717a' : '#9ca3af'}
              strokeWidth="2.2"
              strokeLinecap="round"
              strokeLinejoin="round"
            >
      ...
      >
        <div className="relative p-6 group">
          ...
          <svg
            ...
            fill="none"
            stroke={isPriyaActive ? '#f472b6' : isDark ? '#52525b' : '#9ca3af'}
          ...
          >
            ...
            <motion.path
              ...
              transition={{
                pathLength: { duration: 1.6, ease: 'easeInOut', delay: 0.5 },
                stroke: { duration: 0.3 },
              }}
            />
          </svg>
          ...
          <div className="relative z-10 text-center px-4 py-2">
            <p
              className={`font-editorial text-[24px] md:text-[26px] tracking-wide leading-tight transition-all duration-300 ${
                isPriyaActive
                  ? 'text-pink-400 drop-shadow-[0_0_12px_rgba(244,114,182,0.4)]'
                  : isDark ? 'text-neutral-400 group-hover:text-pink-300' : 'text-neutral-500 group-hover:text-pink-600'
              }`}
            >
              Ideas<br />that stay
            </p>
          ...
          <div className="absolute -bottom-1 right-8 w-6 h-6">
            <svg
              viewBox="0 0 24 24"
              fill="none"
              stroke={isPriyaActive ? '#f472b6' : isDark ? '#71717a' : '#9ca3af'}
              strokeWidth="1.8"
              strokeLinecap="round"
              strokeLinejoin="round"
              className="w-full h-full"
          ...
          {/* Sparkle doodle ✦ */}
          <div className="absolute -top-1 left-4 text-purple-400 text-sm font-handwriting">
            ✦
          </div>

          {/* Hover hint tag */}
          <div
            className={`absolute -bottom-6 left-1/2 -translate-x-1/2 whitespace-nowrap text-[10px] font-sans-clean tracking-wider uppercase transition-opacity duration-200 ${
