  ...
  return (
    <>
      ...
      >
        ...
        {!open && (
          <span className="absolute -top-0.5 -right-0.5 h-2.5 w-2.5 rounded-full bg-orange-500 ring-2 ring-white dark:ring-black shadow-[0_0_8px_rgba(249,115,22,0.9)]" />
        )}
      </button>
          ...
          >
              ...
              <div className="flex items-center gap-2">
                <span
                  className={`flex h-7 w-7 items-center justify-center rounded-full ${
                    isDark ? "bg-orange-500/20 text-orange-400" : "bg-orange-500/15 text-orange-500"
                  }`}
                >
                  <Robot size={14} />
                </span>
                ...
                >
                  ...
                  <div
                    className={`max-w-[80%] rounded-2xl px-3 py-2 text-[12px] leading-relaxed ${
                      msg.sender === "user"
                        ? "bg-orange-500/20 border border-orange-500/40 text-zinc-900 dark:text-white rounded-br-sm"
                        : isDark
                  ...
                  <button
                    ...
                    className={`rounded-full border px-2.5 py-1 text-[10px] font-medium transition-colors ${
                      isUsed
                        ...
                        : isDark
                        ? "border-white/15 text-zinc-300 hover:border-orange-500/60 hover:text-white"
                        : "border-zinc-200 text-zinc-600 hover:border-orange-500/60 hover:text-zinc-900"
                    }`}
                  >
                    {q}
                  </button>
            ...
            >
              ...
              <button
                ...
                data-cursor="hover"
                className="inline-flex h-8 w-8 items-center justify-center rounded-full bg-orange-500 text-white transition-all hover:bg-orange-600 disabled:opacity-40 disabled:cursor-not-allowed shrink-0 shadow-[0_0_12px_rgba(249,115,22,0.4)]"
                aria-label="Send"
              >
